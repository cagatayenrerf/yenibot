...
module.exports.run = async(client, message, args) => {
  const duration = moment.duration(client.uptime).format(" D [gün], H [saat], m [dakika], s [saniye]");
    ...
    .addField(`Discord.js sürümü:`, Discord.version)
      .addField(':spy: Yapımcım:', '<@512629403675525139> \n')
      .addField(':paperclip: Botun Başlanma Zamanı:', "Bot **23.07.2017**'de yapılmaya başlanmıştır")
    .setFooter('Sagaris | İstatistik', client.user.avatarURL)
    .setTimestamp()
